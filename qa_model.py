...
class VQAModel(object):
    def __init__(self, batch_size, feature_dim, proj_dim,
        ...
        self.lstm_hidden_dim = feature_dim/2
        ...
        self.init_hidden_W = self.init_weight(
                self.embed_dim, self.lstm_dim_hidden,name='init_hidden_W')
        self.init_hidden_b = self.init_bias(self.lstm_dim_hidden,
                name='init_hidden_b')
    ...
    def forward_prop(self, h1, c1, h2, c2, word_emb, is_train=True, reuse=False):
        ...
        lstm_preactive2 = tf.matmul(h2, self.lstm_U2) + \
                            tf.matmul(h, self.lstm_W2) + self.lstm_b2
    ...
    def question_embed(question):
        ...
        for idx in range(self.n_lstm_steps):
            ...
            h1, c1, h2, c2 = self.forward_pass(h1, c1, h2, c2, word_embed, reuse=idx)
