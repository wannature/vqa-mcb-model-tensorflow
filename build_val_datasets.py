...
def create_annotations_result():
    ...
    annotations_result(train only answers with confidence 'yes')
        image_idx_list : list of image ids (with original index)
        image_id_list : list of image ids (with index of feature vector)
    ...
    image_idx_list, image_id_list, question_list, question_id_list, answer_list = \
            [], [], [], []
